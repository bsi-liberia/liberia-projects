...
def mtef(_self, ws):
    ...
    ws["D20"] = "For new projects, add new rows at the bottom of the sheet. Leave the ID column blank."
...
def disbursements(_self, ws):
    ...
    ws["D16"] = "The amount you spent on this project in the last fiscal quarter, in {}.".format(
        _self.template_currency)
    ws["D16"].font = Font(size=14)
    ws.merge_cells("D16:K16")

    ws["A17"] = "Other project data"
    ws["A17"].font = Font(size=14)
    ws.merge_cells("A17:C17")
    ws["D17"] = "Please check other project data and update it as required."
    ...
    ws["D18"] = "For new projects, add new rows at the bottom of the sheet. Leave the ID column blank."
    ws["D18"].font = Font(size=14)
